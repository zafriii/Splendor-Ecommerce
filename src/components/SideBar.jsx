...
// const Sidebar = ({ isOpen, toggle, searchTerm, handleSearch, totalPages, paginate, currentPage, selectedOutfit, handleOutfitFilter, filters, selectedBrand, handleBrandFilter, sortByPrice, handleSortByPrice, clearFilters, children }) => {
//     return (
//         <div className="main-container">
//             <motion.div
//                 animate={{
